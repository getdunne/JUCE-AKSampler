...
namespace AudioKitCore
{
    ...
    void VoiceBase::start(unsigned evt, unsigned noteNum, float freqHz, float volume)
    {
        event = evt;
        noteVol = volume;
        noteHz = freqHz;
    ...
    void VoiceBase::restart(unsigned evt, unsigned noteNum, float freqHz, float volume)
    {
        event = evt;
